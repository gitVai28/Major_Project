  ...
  const handleUpdateProfile = async (updates) => {
    try {
      ...
      if (updatedUser.profilePhoto && !updatedUser.profilePhoto.startsWith("http")) {
        updatedUser.profilePhoto = `http://localhost:5000${updatedUser.profilePhoto}`;
      }
      setUser(updatedUser);
      ...
      <nav className="bg-white shadow-md sticky top-0 z-50 w-full">
        <div className="max-w-[150rem] mx-auto w-full px-6 md:px-8 py-10 flex justify-between items-center">
          ...
          <ul className="flex flex-wrap space-x-8 md:space-x-6 items-center text-3xl font-bold gap-10">
            ...
            <li>
              <button className="text-blue-800 hover:text-blue-500">Explore</button>
            </li>
            <li>
              <button className="text-blue-800 hover:text-blue-500">My Applications</button>
            </li>
            <li>
              <button
            ...
            <div className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl p-12 space-y-10">
              <div className="flex items-center gap-8">
                ...
                <div className="flex flex-col gap-3">
                  <h1 className="text-6xl font-extrabold text-indigo-700">My Profile</h1>
              ...
              <div className="space-y-8 text-2xl">
                ...
                <InfoRow
                  ...
                  onSave={(val) =>
                    handleUpdateProfile({ skills: val.split(",").map((s) => s.trim()) })
                  }
                />
                <InfoRow
                  label="Interests"
                  ...
                  onSave={(val) =>
                    handleUpdateProfile({ interests: val.split(",").map((i) => i.trim()) })
                  }
                />
              </div>
              ...
              <div className="mt-12 p-6 border-2 border-red-400 rounded-2xl bg-red-50">
                <h2 className="text-3xl font-bold text-red-600 mb-4">⚠️ Danger Zone</h2>
